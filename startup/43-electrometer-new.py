...
quadem_iss = QuadEM('XF:08ID1-ES{EM:01}', name = 'quadem_iss')
...
class BMMQuadEM(QuadEM):
    ...
    def enable_electrometer(self):
        ...
        '''
        stats_pvs = ('XF:08ID1-ES{EM:01}Current1:EnableCallbacks',
                     'XF:08ID1-ES{EM:01}Current2:EnableCallbacks',
                     'XF:08ID1-ES{EM:01}Current3:EnableCallbacks',
                     'XF:08ID1-ES{EM:01}Current4:EnableCallbacks',
                     'XF:08ID1-ES{EM:01}SumX:EnableCallbacks',
                     'XF:08ID1-ES{EM:01}SumY:EnableCallbacks',
                     'XF:08ID1-ES{EM:01}SumAll:EnableCallbacks',
                     'XF:08ID1-ES{EM:01}DiffX:EnableCallbacks',
                     'XF:08ID1-ES{EM:01}DiffY:EnableCallbacks',
                     'XF:08ID1-ES{EM:01}PosX:EnableCallbacks',
                     'XF:08ID1-ES{EM:01}PosY:EnableCallbacks')
        for pv in stats_pvs:
            EpicsSignal(pv, name='').put(1)
        EpicsSignal('XF:08ID1-ES{EM:01}Range', name='').put(7)
        EpicsSignal('XF:08ID1-ES{EM:01}AveragingTime', name='').put(0.5)
        EpicsSignal('XF:08ID1-ES{EM:01}Acquire', name='').put(1)
    ...
    def get_current_offsets(self):
        return (self.current_offsets.ch1.get(), self.current_offsets.ch2.get(), self.current_offsets.ch3.get(),
                self.current_offsets.ch4.get())
...
em2_test = BMMQuadEM('XF:08ID1-ES{EM:01}', name = 'em2_test')
