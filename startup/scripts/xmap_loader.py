...
files = [
#        "tmp3_sca_000.h5",
         "/nsls2/data/iss/legacy/Sandbox/epics/raw/dxp/2025/02/10/5088528d-4fc8-40d1-87a6_000000.h5"]
...
#    fname = r"C:/nsls/test_006.h5"
    ...
    decoded_data = decode_xmap_buffers(data)
    print(decoded_data.counts.shape)
    # print(mapmode)
    # print(f"{mapmode=}")
#    if mapmode == 2:
#        print(fname)
print(decoded_data.counts)
#print(decoded_data.counts.shape)
# real / live times are returned in microseconds.
#print(decoded_data.realTime.shape)
#print(decoded_data.liveTime)
# plt.figure()
# plt.plot(decoded_data.realTime[:, 0])
#for channel in range(32):
#    plt.plot(decoded_data.realTime[1:5000, channel])
#plt.imshow(decoded_data.realTime[:128, :])
#plt.show()
